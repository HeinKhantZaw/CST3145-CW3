    ...
    fetchLessons: async function () {
      ...
      this.lessons.map(async (lesson) => {
        this.images.push({
          ...
          URL: this.imageURL + lesson.Subject.toLowerCase() + ".jpg"
        });
      });
    },
    fetchAndFilterLessons: async function () {
      const response = await fetch(`${this.apiURL}search?query=${this.searchQuery}&sortBy=${this.sortBy}&sortOrder=${this.sortOrder}`);
      this.lessons = await response.json();
    },
      ...
      <main class="col-md-10 col-12 pt-3 px-4">
        <div class="row">
          ...
          <div class="d-flex d-md-none">
            ...
            <div class="dropdown mx-5">
              <button class="btn btn-secondary dropdown-toggle" type="button" id="sortByDropdown" data-toggle="dropdown"
              ...
              <div class="dropdown-menu" aria-labelledby="sortByDropdown">
                ...
                <a class="dropdown-item" @click="sortBy = 'Spaces'">Availability</a>
              </div>
            </div>
            ...
            <div class="dropdown mx-5">
              ...
              <div class="dropdown-menu" aria-labelledby="orderDropdown">
                <a class="dropdown-item" @click="sortOrder = 'asc'">Ascending</a>
                <a class="dropdown-item" @click="sortOrder = 'dsc'">Descending</a>
              </div>
            </div>
          </div>
        ...
        <div class="row">
          ...
          <div class="col-lg-4 col-sm-12" v-for="lesson in lessons">
            <div class="card mb-4">
              <img class="card-img-top" :src="images.find(image=>image.Subject===lesson.Subject).URL"
                   :alt="lesson.Subject">
              <div class="card-body">
